...
function send_question_form()
{
    ...
    $subject = "Отправка с формы - Остались вопросы?";
...
add_action('wp_ajax_send_question_form', 'send_question_form');
add_action('wp_ajax_nopriv_send_question_form', 'send_question_form');